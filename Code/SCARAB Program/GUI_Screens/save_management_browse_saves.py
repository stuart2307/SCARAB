...
class Ui_browse_saves(object):
    def setupUi(self, browse_saves):
        if not browse_saves.objectName():
            browse_saves.setObjectName(u"browse_saves")
        browse_saves.resize(650, 600)
        palette = QPalette()
...
#endif
        browse_saves.setPalette(palette)
        browse_saves.setAutoFillBackground(True)
        ...
        self.select_save_label = QLabel(browse_saves)
        ...
        self.back_button.setGeometry(QRect(60, 480, 171, 71))
        self.back_button.setFont(font)
        self.delete_button = QPushButton(browse_saves)
        ...
        QMetaObject.connectSlotsByName(browse_saves)
    # setupUi

    def retranslateUi(self, browse_saves):
        browse_saves.setWindowTitle(QCoreApplication.translate("browse_saves", u"Frame", None))
        self.rename_button.setText(QCoreApplication.translate("browse_saves", u"Rename", None))
        self.det_game_label.setText(QCoreApplication.translate("browse_saves", u"Detected Game:", None))
        self.select_save_label.setText(QCoreApplication.translate("browse_saves", u"Select Save File", None))
