...
################################################################################
## Form generated from reading UI file 'identifying.ui'
##
...
class Ui_identifying(object):
    def setupUi(self, identifying):
        if not identifying.objectName():
            identifying.setObjectName(u"identifying")
        identifying.resize(650, 600)
        palette = QPalette()
...
#endif
        identifying.setPalette(palette)
        identifying.setAutoFillBackground(True)
        self.identifying_label = QLabel(identifying)
        self.identifying_label.setObjectName(u"identifying_label")
        self.identifying_label.setGeometry(QRect(230, 430, 190, 50))
        font = QFont()
        font.setPointSize(25)
        self.identifying_label.setFont(font)

        self.retranslateUi(identifying)

        QMetaObject.connectSlotsByName(identifying)
    # setupUi

    def retranslateUi(self, identifying):
        identifying.setWindowTitle(QCoreApplication.translate("identifying", u"Frame", None))
        self.identifying_label.setText(QCoreApplication.translate("identifying", u"Identifying...", None))
    # retranslateUi
