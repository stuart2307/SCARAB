...
class Ui_modules_menu(object):
    def setupUi(self, modules_menu):
        ...
        self.inserted_game.setGeometry(QRect(340, 380, 291, 41))
        self.inserted_game.setFont(font)
        self.inserted_game.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.inserted_game.setWordWrap(False)
        ...
        self.inserted_module.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
