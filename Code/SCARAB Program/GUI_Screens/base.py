...
class Ui_SCARAB_MENU(object):
    def setupUi(self, SCARAB_MENU):
        ...
        self.message_banner = QFrame(self.centralwidget)
        self.message_banner.setObjectName(u"message_banner")
        self.message_banner.setEnabled(True)
        self.message_banner.setGeometry(QRect(180, 20, 591, 71))
        palette1 = QPalette()
        brush12 = QBrush(QColor(74, 53, 144, 255))
        ...
        self.message_banner.setPalette(palette1)
        self.message_banner.setAutoFillBackground(True)
        self.message_banner.setFrameShape(QFrame.Shape.StyledPanel)
        self.message_banner.setFrameShadow(QFrame.Shadow.Raised)
        self.message = QLabel(self.message_banner)
        self.message.setObjectName(u"message")
        self.message.setGeometry(QRect(0, 0, 591, 71))
        font1 = QFont()
    ...
    def retranslateUi(self, SCARAB_MENU):
        ...
        self.message.setText(QCoreApplication.translate("SCARAB_MENU", u"TextLabel", None))
    # retranslateUi
