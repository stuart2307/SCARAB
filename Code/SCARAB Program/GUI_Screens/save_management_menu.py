...
class Ui_save_management(object):
    def setupUi(self, save_management):
        if not save_management.objectName():
            save_management.setObjectName(u"save_management")
        save_management.resize(650, 600)
        palette = QPalette()
...
#endif
        save_management.setPalette(palette)
        save_management.setAutoFillBackground(True)
        self.det_game_label = QLabel(save_management)
        self.det_game_label.setObjectName(u"det_game_label")
        self.det_game_label.setGeometry(QRect(60, 10, 201, 41))
        font = QFont()
        font.setPointSize(20)
        self.det_game_label.setFont(font)
        self.browse_saves_button = QPushButton(save_management)
        ...
        self.dump_save_button = QPushButton(save_management)
        ...
        QMetaObject.connectSlotsByName(save_management)
    # setupUi

    def retranslateUi(self, save_management):
